...
from flaskblog.forms import PatientForm, MedicineForm, RegistrationForm, LoginForm, DetailForm, AddWorkLogForm, UpdateDoctorForm, UpdateDoctorPasswordForm, AdminLoginForm, AdminRegistrationForm, AddannouncementForm
...
def add_patient_detail(patient_id): 
    form = DetailForm()   
    if form.validate_on_submit():  
        detail = Detail(Symptom=form.Symptom.data, Initial_diagnosis=form.Initial_diagnosis.data,
        Preliminary_treatment_plan=form.Preliminary_treatment_plan.data, Check_result=form.Check_result.data, 
        Patient_reason=form.Patient_reason.data, Formula=form.Formula.data)
...
def patient_detail_update(patient_id): 
    ...
    if form.validate_on_submit(): 
        ...
        detail.Initial_diagnosis = form.Initial_diagnosis.data 
        detail.Preliminary_treatment_plan = form.Preliminary_treatment_plan.data 
        detail.Check_result = form.Check_result.data 
        detail.Patient_reason = form.Patient_reason.data
        detail.Formula = form.Formula.data
        db.session.commit()
        flash('患者信息已更改!', 'success') 
        ...
        form.Initial_diagnosis.data = detail.Initial_diagnosis
        form.Preliminary_treatment_plan.data = detail.Preliminary_treatment_plan 
        form.Check_result.data = detail.Check_result
        form.Patient_reason.data = detail.Patient_reason 
        form.Formula.data = detail.Formula
...
@app.route("/update-doctor-password/<int:user_id>", methods=['GET', 'POST']) 
@login_required 
def update_doctor_password(user_id):
    user = User.query.get_or_404(user_id)  
    form = UpdateDoctorPasswordForm()  
    if form.validate_on_submit(): 
    ...
    return render_template('update-doctor.html', title='Update Doctor', 
                           form=form, legend='Update Doctor')  
...
@app.route('/transport/<int:admin_id>', methods=['POST', 'GET']) 
def transport(admin_id): 
    admin = Admin.query.filter_by(admin_id)
    return render_template('transport.html', admin=admin) 
...
def _add_doctor_from_admin(admin_id): 
    ...
    if form.validate_on_submit():
        hashed_password = bcrypt.generate_password_hash(form.password.data).decode('utf-8')
        user = User(name=form.name.data, department=form.department.data, password=hashed_password)
        db.session.add(user)  
        db.session.commit()   
